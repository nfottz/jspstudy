...
public class HelloServlet extends HttpServlet {
	...
	/*
		4. doGet()
			...
			2) GET 방식의 요청의 예시
				...
				(2) <form action="http://localhost:9090/01_Servlet/HelloServlet">		: js17장
				(3) location.href="http://localhost:9090/01_Servlet/HelloServlet"		: js18장
	...
	*/
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 출력 스트림으로 정보(텍스트)를 보내는 메소드 : append(), write(), print(), println() 등
		response.getWriter().append("Served at: ").append(request.getContextPath());	// 보내지는 정보 - " Served at: /01_Servlet "
	}
	...
	*/
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// POST 메소들을 통해서 넘어온 정보를 모두 doGet() 메소드에 넘긴다.
